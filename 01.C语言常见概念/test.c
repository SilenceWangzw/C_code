...
//2.只是参数部分多了void，这里的void表示main函数没有参数
//int main(void)
//{
//	return 0;
//}
...
//3.其实main函数可以有参数，他的参数是有特殊意义的，如果想使用main函数的参数，那就写上，如果不想使用main函数的参数就不写
//暂时不需要了解main函数的参数
...
//strlen 是一个库函数 -- 求字符串长度，统计的是字符串中\0之前的字符个数
//使用strlen需要包含头文件string.h
//strlen 返回的值是size_t类型的，应该使用%zd来打印
//#include<string.h>
//int main()
//{
//	char arr1[] = "abcdef";
...
//int main()
//{
//	printf("%c\n", '\130'); //八进制130 --> 十进制88 --> 88对应的ACSII码为X
